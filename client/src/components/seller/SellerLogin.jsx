...
const SellerLogin = () => { 
  ...
  return !isSeller && ( 
    ...
    min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200'>
        <p className='text-2xl font-medium m-auto'><span className='text-purple-400'>Seller </span>Login</p>
        ...
        <button className='bg-pink-400 text-white w-full py-2 rounded-md'>Login</button>
    </div>
