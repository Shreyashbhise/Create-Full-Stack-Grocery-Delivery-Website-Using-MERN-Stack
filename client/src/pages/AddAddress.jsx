...
const AddAddress = () => { 
  ...
  return (
    <div className='mt-16 pb-16'>
        <p className="text-2xl md:text-3xl text-gray-500">Add Shipping <span className='font-semibold text-pink-400'>Address</span></p>
        <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
            <div className='flex-1 max-w-md'>
                <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                    ...
                    <button className='w-full mt-6 bg-blue-500 text-white py-3
